...
def main():
    """
    Writes out "transcript-userId.json" with the history of the group
...
def populateTranscript(user_id, accessToken, transcript, beforeId, stopId, pageLimit=None):
    complete = False
    pageCount = 0
    endpoint = 'https://v2.groupme.com/direct_messages/' + user_id
    headers = {
        ...
        'Referer': 'https://web.groupme.com/direct_messages/' + user_id,
